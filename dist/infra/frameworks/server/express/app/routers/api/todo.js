...
// Ajout de 1 Todo
router.post('/', (0, controllerHandler_1.default)((0, bodyValidation_1.default)(schemas_1.default.addTodoSchema)), (0, controllerHandler_1.default)(todo_1.default.addTodo));
// Récupération de tous les todos
router.get('/find-all-todos', (0, controllerHandler_1.default)(todo_1.default.findAllTodos));
// Update d'une Todo
router.patch('/:id', (0, controllerHandler_1.default)((0, paramValidation_1.default)(schemas_1.default.idParamSchema)), (0, controllerHandler_1.default)((0, bodyValidation_1.default)(schemas_1.default.updateTodoSchema)), (0, controllerHandler_1.default)(todo_1.default.updateTodo));
// Recherche de 1 Todo
...
// Check Toggle 1 Todo
router.patch('/toggle-check/:id', (0, controllerHandler_1.default)((0, paramValidation_1.default)(schemas_1.default.idParamSchema)), (0, controllerHandler_1.default)((0, bodyValidation_1.default)(schemas_1.default.checkToggleTodoSchema)), (0, controllerHandler_1.default)(todo_1.default.checkToggleOneTodo));
